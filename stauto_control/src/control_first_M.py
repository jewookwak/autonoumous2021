...
if __name__ == '__main__':
    ...
    state_machine = np.zeros(6)
    prev_state_machine = np.zeros(6)
    ...
    while not rospy.is_shutdown():
        ...
        elif(state_machine[3]==1 or state_machine[4]==1):
        ...
        #print(state_machine)
        if((prev_state_machine[0]==1 and state_machine[1]==1) or (prev_state_machine[0]==1 and state_machine[3]==1) or (prev_state_machine[0]==1 and state_machine[4]==1)):
