...
def delivery_bool_callback(data):
    global delivery_bool_sign

    delivery_bool_sign=data.data
...
if __name__ == '__main__':
    ...
    rospy.Subscriber("/delivery_bool", Bool, delivery_bool_callback)
    ...
    while not rospy.is_shutdown():
        ...
        if(state_machine[0]==1):
            ...
            if delivery_bool_sign==False:
                ...
                if (time.time()-delivery_finish_time<0.3):
                    ackermann.drive.speed = 0.0
                    ackermann.drive.steering_angle = 0.0
                    ackermann.drive.jerk = 100
                    ackermann.drive.acceleration = 0
                    print(1)
                elif (time.time()-delivery_finish_time<3.5):
                    ackermann.drive.speed = 3.0
                    ackermann.drive.steering_angle = -28.0*np.pi/180
                    ackermann.drive.jerk = 0
                    ackermann.drive.acceleration = 0
                    print(2)
                elif (time.time()-delivery_finish_time<7):
                    ackermann.drive.speed = 3.0
                    ackermann.drive.steering_angle = 0.0
                    ackermann.drive.jerk = 0
                    ackermann.drive.acceleration = 0
                    print(3)
                elif (time.time()-delivery_finish_time<12):
                    ackermann.drive.speed = 0.0
                    ackermann.drive.steering_angle = 0.0
                    ackermann.drive.jerk = 100
                    ackermann.drive.acceleration = 0
