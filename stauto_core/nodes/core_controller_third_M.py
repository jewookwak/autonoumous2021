...
class CoreController():
    def __init__(self):
        ...
        self.sub_big_obstacle_End = rospy.Subscriber('/big_obstacle_end',Bool, self.cbBig_obstacle_End, queue_size=1)
    ...
    def cbBig_obstacle_End(self,event_msg):
        self.big_obstacle_end = event_msg.data
    ...
    def cbBackup(self,event_msg):
        ...
        #         self.stop_line = 1
            ...
            if(self.big_obstacle_end == False):
                self.backup_state = self.Machine_State.avoid_cruise.value
            elif(self.big_obstacle_end == True):
                self.backup_state = self.Machine_State.cruise.value
        ...
        if (10<= self.step_num <= 11): #delivery_A   mission(7)
        ...
        elif (15 <= self.step_num and self.step_num <= 45): #delivery_B  mission(9)
