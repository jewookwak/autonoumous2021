        ...
        try:
            if D_end==False:
                ...
                if D_sign==False: #find delivery space & read delivery path
                        ...
                        if D_num==1:
                            if D_zone_number != 1:
                                D_zone_number=1 # D_zone_number ==1
                                D_sign=True
                                create_path_msg=False
                                f = open(arg_name + "delivery1"+".txt","r")
                            ...
                            if D_zone_number != 2:
                                D_zone_number=2 # D_zone_number ==1
                                D_sign=True
                                create_path_msg=False
                                f = open(arg_name + "delivery2"+".txt","r")
                                D_data = f.readlines() # D_data : txt 파일에서 읽은 gps 좌표
                                last_step=len(parking_data)
                                pathmsg=Path()
                            ...
                            if D_zone_number != 3:
                                D_zone_number=3 # D_zone_number ==1
                                D_sign=True
                                create_path_msg=False
                                f = open(arg_name + "delivery3"+".txt","r")
                                D_data = f.readlines() # D_data : txt 파일에서 읽은 gps 좌표
                                last_step=len(parking_data)
                                pathmsg=Path()
